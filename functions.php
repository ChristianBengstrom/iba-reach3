<?php
/**
 * iba-reach2 functions and definitions
 *
...
if ( ! function_exists( 'iba_reach2_setup' ) ) :
	/**
	 ...
	 */
	function iba_reach2_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on iba-reach2, use a find and replace
		 * to change 'iba-reach2' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'iba-reach2', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'iba_reach2_custom_background_args', array(
...
add_action( 'after_setup_theme', 'iba_reach2_setup' );
 ...
 */
function iba_reach2_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'iba_reach2_content_width', 640 );
}
add_action( 'after_setup_theme', 'iba_reach2_content_width', 0 );
...
add_action( 'widgets_init', 'iba_reach2_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'iba_reach2_scripts' );
